...
const VideoCheck = ({ saveDescriptionResult, getVideoDetail, curator: { videos, video } }: any) => {
  ...
  const { video_check_tag, video_category, video_play, video_duplicate, video_check_description, video_check_comment } =
    formData;
          ...
          <Row>
            <Col xs={24} xl={8} style={{ paddingRight: '40px', paddingLeft: '20px' }}>
              <Card title="Video Detail" style={{ textAlign: 'left' }}>
                ...
                <h6>
                  <b>Video Title:</b>{' '}
                  <Link to={`https://gleev.xyz/video/${video.key}`} target="_blank">
                    {video.video_title}
                  </Link>
                </h6>
              </Card>
              <form className="form" onSubmit={onSubmit}>
                ...
                <div className="form-group">
                  ...
                  <select name="video_check_description" value={video_check_description} onChange={onChange}>
                    ...
                    <option value="Copy video from Animation/Cartoon movies.">
                      Copy video from Animation/Cartoon movies.
                    </option>
                    ...
                    <option value="Video from creators Youtube channel but not YPP.">
                      Video from creators Youtube channel but not YPP.
                    </option>
